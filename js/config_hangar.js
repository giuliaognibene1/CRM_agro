const dati = {
    ...
    // TESTATA CON PORTONE
    una_testata_portone: {
    "ANTADX-PORTONEP - ANTA DX PORTONE PICCOLO HANGAR 3800 MM": 1,
    "ANTASX-PORTONEP - ANTA SX PORTONE PICCOLO HANGAR 3800 MM": 1,
    "GUIDAINFER-3.80 - GUIDA INFER HANGAR PORTONE 3.80 (L.730)": 1,
    "GUIDASUPER-3.80 - GUIDA SUPERIORE 6.00M + MINIGONNE": 1,
    "CAVALLOTTOZN-48 - CAVALLOTTO ZN A TETTO x TUBO 48": 8,
    "KITPORTA-P - KIT PORTONE HANGAR PICCOLO 3.80M": 1,
    "MORSETTO-T-48X48 - MORSETTO A T 48X48 ZN (NO BULLONI)": 24,
    "LAMIERA-3000 - LAMIERA GREC.OR38 732 0,6MM L 3.00": 6,
    "LAMIERA-4100 - LAMIERA GREC.OR38 732 0,6MM L 4.10": 2,
    "LAMIERA-4500 - LAMIERA GREC.OR38 732 0,6MM L 4.50": 6,
    "HANGARTUBO48L6000 - TUBO ZINCATO DIAM 48 L 6.00M SP 3.00MM": 5,
    "HANGARTUBO76L6000 - TUBO ZINCATO DIAM 76 L 6.00M SP 3.00MM": 2,
    "STAFFELAMIERA - STAFFE FISSAGGIO LAMIERA": 28,
    "FINESTRA1600 - PROFILO U FINESTRE L1650 H600 P950 MM": 3,
    "HANGARPROFILOL - PROFILO CONTORNO TESTATE 8,5x8 LUNG. 2M": 8,
    "HANGARPROFILOU - PROFILO BASE PARETE 8x10x8 LUNG. 4": 2,
    "HANGARTAMPLAT-3800 - PROFILO TAMPONAMENTO LAT. PORTONE 3.80": 2,
    "HANGARTAMPSUP-3800 - TAMPONAMENTO SUPER PORTONE 3.80 L4000": 1,
    "FERMAPORTA - FERMAPORTA A BATTENTE FISSAGGIO TERRA": 2
    },
    due_testata_portone: {
    "ANTADX-PORTONEP - ANTA DX PORTONE PICCOLO HANGAR 3800 MM": 2,
    "ANTASX-PORTONEP - ANTA SX PORTONE PICCOLO HANGAR 3800 MM": 2,
    "GUIDAINFER-3.80 - GUIDA INFER HANGAR PORTONE 3.80 (L.730)": 2,
    "GUIDASUPER-3.80 - GUIDA SUPERIORE 6.00M + MINIGONNE": 2,
    "CAVALLOTTOZN-48 - CAVALLOTTO ZN A TETTO x TUBO 48": 16,
    "KITPORTA-P - KIT PORTONE HANGAR PICCOLO 3.80M": 2,
    "MORSETTO-T-48X48 - MORSETTO A T 48X48 ZN (NO BULLONI)": 48,
    "LAMIERA-3000 - LAMIERA GREC.OR38 732 0,6MM L 3.00": 12,
    "LAMIERA-4100 - LAMIERA GREC.OR38 732 0,6MM L 4.10": 4,
    "LAMIERA-4500 - LAMIERA GREC.OR38 732 0,6MM L 4.50": 12,
    "HANGARTUBO48L6000 - TUBO ZINCATO DIAM 48 L 6.00M SP 3.00MM": 10,
    "HANGARTUBO76L6000 - TUBO ZINCATO DIAM 76 L 6.00M SP 3.00MM": 4,
    "STAFFELAMIERA - STAFFE FISSAGGIO LAMIERA": 56,
    "FINESTRA1600 - PROFILO U FINESTRE L1650 H600 P950 MM": 6,
    "HANGARPROFILOL - PROFILO CONTORNO TESTATE 8,5x8 LUNG. 2M": 16,
    "HANGARPROFILOU - PROFILO BASE PARETE 8x10x8 LUNG. 4": 4,
    "HANGARTAMPLAT-3800 - PROFILO TAMPONAMENTO LAT. PORTONE 3.80": 4,
    "HANGARTAMPSUP-3800 - TAMPONAMENTO SUPER PORTONE 3.80 L4000": 2,
    "FERMAPORTA - FERMAPORTA A BATTENTE FISSAGGIO TERRA": 4
    },

    // TESTATA CHIUSA
    zero_testata_chiusa: { },
    una_testata_chiusa: {
    "LAMIERA-5600 - LAMIERA GREC.OR38 732 0,6MM L 5.60": 4,
    "LAMIERA-4500 - LAMIERA GREC.OR38 732 0,6MM L 4.50": 6,
    "LAMIERA-4100 - LAMIERA GREC.OR38 732 0,6MM L 4.10": 4,
    "HANGARTUBO48L6000 - TUBO ZINCATO DIAM 48 L 6.00M SP 3.00MM": 5,
    "HANGARTUBO76L6000 - TUBO ZINCATO DIAM 76 L 6.00M SP 3.00MM": 2,
    "FINESTRA1600 - PROFILO U FINESTRE L1650 H600 P950 MM": 3,
    "HANGARPROFILOL - PROFILO CONTORNO TESTATE 8,5x8 LUNG. 2M": 8,
    "HANGARPROFILOU - PROFILO BASE PARETE 8x10x8 LUNG. 4": 3,
    "KITCIECA-P - KIT TESTATA CIECA HANGAR 10,40x3,80M": 5
    }
};
...
function nomePulito(valore) {
    ...
    const nomi = {
        mod_10_40: "modello 10,40",
        mod_13_30: "modello 13,30",
        ...
        una_testata_portone: "Una testata con portone",
        una_testata_chiusa: "Una testata chiusa",
        due_testata_portone: "Due testate con portone",
        zero_testata_chiusa: "Nessuna testata chiusa",
...
function aggiorna() {
    ...
    document.querySelectorAll("select[data-cat]").forEach(select => {
        ...
        if (dati[val]) {
            ...
            if (val.startsWith("lung_")) {
                let modello = document.querySelector(
                    'select[data-cat="Modello"]'
                ).value;

                aggiungi(dati[val].comuni, cat);

                if (dati[val][modello]) {
                    aggiungi(dati[val][modello], cat);
                }
...
function creaPDF(doc, logo, cliente, data) {
    ...
    doc.save("configurazione-hangar.pdf");
}
